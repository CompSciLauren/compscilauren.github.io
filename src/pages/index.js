...
const About = () => (
  <div className="container-fluid">
    ...
    <div className="darker-background">
      ...
      <h3 className="left">
        Christy McWard, Director of Communications & Advancement at University
        of Kansas
      </h3>
      <h4>April 2018</h4>
      <p>
        ...
        excels in her classes while building strong relationships with faculty
        and classmates. As a campus leader, she is engaged in several groups,
        not only as a member, but often as an officer, a co-founder, an event
        planner, or a public speaker on behalf of the groups she belongs to. As
        an employee of JCCC's Collaboration Center, the CoLab, where I was her
        supervisor, she was a shining example of what it means to be a
        committed, responsible and enthusiastic colleague. And finally, she is a
        delightful person through and through. Her kindness, compassion and
        curiosity about the world are contagious among all who have the good
      ...
      <p>
        ...
        insightful and vibrant first meeting, I was impressed with her desire to
        enhance the Computer Club experience. As the President of the Club,
        Lauren, worked with the Faculty Facilitator to incorporate me into the
        meetings. It has been a very rewarding experience for me thus far and
        the feedback from the group has been positive. Lauren has visited with
        me and on a number of occasions to talk about career planning, course
        selection and how to integrate with local IT professional organizations.
        Lauren is well poised in her education to make innovative contributions
        to the IT Industry, the local organizations she will become involved
        with and the way we use technology to make our lives better. I look
        forward to the ongoing interaction with Lauren as she moves on to future
        success.”
      </p>
    </div>
    <hr />
    ...
    <div className="custom-image-adjust">
      <img
        ...
        src={lauren_holding_cat}
        alt="Lauren holding an orange cat."
      />
    </div>
    ...
    <p>
      ...
      I'm always open to listening! Please feel free to contact me at any time.
    </p>
    <hr />
    <div className="custom-image-adjust">
